...
class Select():
    ...
    def __init__(self):
        ...
        target2_1 = Boat(x=300, y=40, r=30, passby=0.4, defend=0.6, v=150, die_v=150, name='T2_1', m_x=[250, 220], m_y=[69, 86])    # 敢死队前上
        target2_2 = Boat(x=300, y=160, r=30, passby=0.4, defend=0.6, v=150, die_v=150, name='T2_2', m_x=[250, 220], m_y=[131, 114])    # 敢死队前下
        target2_3 = Boat(x=350, y=30, r=30, passby=0.4, defend=0.6, v=150, die_v=150, name='T2_3', m_x=[250, 220], m_y=[88, 105])    # 敢死队后上
        target2_4 = Boat(x=325, y=40, r=30, passby=0.4, defend=0.6, v=150, die_v=150, name='T2_4', m_x=[250, 220], m_y=[83, 101])    # 敢死队中上
        target2_5 = Boat(x=325, y=160, r=30, passby=0.4, defend=0.6, v=150, die_v=150, name='T2_5', m_x=[250, 220], m_y=[117, 99])    # 敢死队中下
        target2_6 = Boat(x=350, y=170, r=30, passby=0.4, defend=0.6, v=150, die_v=150, name='T2_6', m_x=[250, 220], m_y=[112, 95])    # 敢死队后下
        target2_7 = Boat(x=380, y=100, r=20, passby=0.3, defend=0.5, v=120, die_v=120, name='T2_7', m_x=[250, 220], m_y=[100, 100])    # 航母前
        target2_8 = Boat(x=390, y=80, r=20, passby=0.3, defend=0.5, v=120, die_v=120, name='T2_8', m_x=[250, 220], m_y=[161, 178])    # 航母前上
        target2_9 = Boat(x=410, y=80, r=20, passby=0.3, defend=0.5, v=80, die_v=80, name='T2_9', m_x=[250, 220], m_y=[172, 190])    # 航母后上
        target2_10 = Boat(x=420, y=100, r=20, passby=0.3, defend=0.5, v=80, die_v=80, name='T2_10', m_x=[250, 220], m_y=[100, 100])  # 航母后
        target2_11 = Boat(x=410, y=120, r=20, passby=0.3, defend=0.5, v=80, die_v=80, name='T2_11', m_x=[250, 220], m_y=[28, 10])  # 航母后下
        target2_12 = Boat(x=390, y=120, r=20, passby=0.3, defend=0.5, v=120, die_v=120, name='T2_12', m_x=[250, 220], m_y=[39, 22])  # 航母前下
    ...
    def step(self, action):
        ...
        if self.s_index < self.n_agent/2:  # 前面一排的导弹
            ...
            self.missile_list[self.s_index].y = self.action_space[action].missile_y[0]
        else:
            self.missile_list[self.s_index].x = self.action_space[action].missile_x[1]
            self.missile_list[self.s_index].y = self.action_space[action].missile_y[1]
        self.s_index += 1
