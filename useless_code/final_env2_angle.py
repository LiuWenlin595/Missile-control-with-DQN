...
class Select():
    ...
    def __init__(self):
        # 更新
        target1_1 = Boat(x=400, y=90, r=0, passby=0, defend=0, v=300, die_v=300, name='T1_1', m_x=[250, 220], m_y=[177, 194])       # 航母上
        target1_2 = Boat(x=400, y=110, r=0, passby=0, defend=0, v=300, die_v=300, name='T1_2', m_x=[250, 220], m_y=[23, 6])       # 航母下
        target2_1 = Boat(x=300, y=40, r=40, passby=0.4, defend=0.6, v=150, die_v=150, name='T2_1', m_x=[250, 220], m_y=[69, 86])    # 敢死队前上
        target2_2 = Boat(x=300, y=160, r=40, passby=0.4, defend=0.6, v=150, die_v=150, name='T2_2', m_x=[250, 220], m_y=[131, 114])    # 敢死队前下
        target2_3 = Boat(x=350, y=30, r=40, passby=0.4, defend=0.6, v=150, die_v=150, name='T2_3', m_x=[250, 220], m_y=[88, 105])    # 敢死队后上
        target2_4 = Boat(x=325, y=40, r=40, passby=0.4, defend=0.6, v=150, die_v=150, name='T2_4', m_x=[250, 220], m_y=[83, 101])    # 敢死队中上
        target2_5 = Boat(x=325, y=160, r=40, passby=0.4, defend=0.6, v=150, die_v=150, name='T2_5', m_x=[250, 220], m_y=[117, 99])    # 敢死队中下
        target2_6 = Boat(x=350, y=170, r=40, passby=0.4, defend=0.6, v=150, die_v=150, name='T2_6', m_x=[250, 220], m_y=[112, 95])    # 敢死队后下
        target2_7 = Boat(x=380, y=100, r=30, passby=0.3, defend=0.5, v=120, die_v=120, name='T2_7', m_x=[250, 220], m_y=[100, 100])    # 航母前
        target2_8 = Boat(x=390, y=80, r=30, passby=0.3, defend=0.5, v=120, die_v=120, name='T2_8', m_x=[250, 220], m_y=[161, 178])    # 航母前上
        target2_9 = Boat(x=410, y=80, r=30, passby=0.3, defend=0.5, v=80, die_v=80, name='T2_9', m_x=[250, 220], m_y=[172, 190])    # 航母后上
        target2_10 = Boat(x=420, y=100, r=30, passby=0.3, defend=0.5, v=80, die_v=80, name='T2_10', m_x=[250, 220], m_y=[100, 100])  # 航母后
        target2_11 = Boat(x=410, y=120, r=30, passby=0.3, defend=0.5, v=80, die_v=80, name='T2_11', m_x=[250, 220], m_y=[28, 10])  # 航母后下
        target2_12 = Boat(x=390, y=120, r=30, passby=0.3, defend=0.5, v=120, die_v=120, name='T2_12', m_x=[250, 220], m_y=[39, 22])  # 航母前下

        # todo  这里需要根据地图的具体大小进行更改
        missile1 = Missile(x=250, y=28, type=0, name='Z1')   # 导弹1
        missile2 = Missile(x=250, y=44, type=0, name='Z2')   # 导弹2
        missile3 = Missile(x=250, y=60, type=0, name='Z3')   # 导弹3
        missile4 = Missile(x=250, y=76, type=0, name='Z4')   # 导弹4
        missile5 = Missile(x=250, y=92, type=0, name='Z5')   # 导弹5
        missile6 = Missile(x=250, y=108, type=0, name='Z6')   # 导弹6
        missile7 = Missile(x=250, y=124, type=0, name='Z7')   # 导弹7
        missile8 = Missile(x=250, y=140, type=0, name='Z8')   # 导弹8
        missile9 = Missile(x=250, y=156, type=0, name='Z9')   # 导弹9
        missile10 = Missile(x=250, y=172, type=0, name='Z10')   # 导弹10
        missile11 = Missile(x=220, y=28, type=0, name='Z11')   # 导弹11
        missile12 = Missile(x=220, y=44, type=0, name='Z12')   # 导弹12
        missile13 = Missile(x=220, y=60, type=0, name='Z13')   # 导弹13
        missile14 = Missile(x=220, y=76, type=0, name='Z14')   # 导弹14
        missile15 = Missile(x=220, y=92, type=0, name='Z15')   # 导弹15
        missile16 = Missile(x=220, y=108, type=0, name='Z16')   # 导弹16
        missile17 = Missile(x=220, y=124, type=0, name='Z17')   # 导弹17
        missile18 = Missile(x=220, y=140, type=0, name='Z18')   # 导弹18
        missile19 = Missile(x=220, y=156, type=0, name='Z19')   # 导弹19
        missile20 = Missile(x=220, y=172, type=0, name='Z20')   # 导弹20
    ...
    def reset_all(self):
        for i in range(10):
            self.missile_list[i].x = 250
            self.missile_list[i].y = 28 + 16*i
            self.missile_list[i+10].x = 220
            self.missile_list[i+10].y = 28 + 16*i
        self.state = (-1)*np.ones(self.n_agent)
        self.V = np.array([[target.V for target in self.action_space]])
        self.A = self.V
        self.array_r = np.log(self.V)
    ...
    def get_target(self, observation):
        count_target = [0]*self.n_action
        for i in observation:
            count_target[int(i)] += 1
        ...
        for i in range(length-1, -1, -1):   # 先给后面的舰艇分配导弹
            ...
            while count < count_target[i]:
                ...
                index += 1
        # 更新
        # 根据分配结果对下一次训练的导弹进行位置的更改
        for i in range(len(agent_result)):
            for missile_index in agent_result[i]:    # 攻击第i个舰艇的导弹编号
                if missile_index < self.n_agent/2:  # 前面一排的导弹
                    self.missile_list[missile_index].x = self.action_space[i].missile_x[0]
                    self.missile_list[missile_index].y = self.action_space[i].missile_y[0]
                else:
                    self.missile_list[missile_index].x = self.action_space[i].missile_x[1]
                    self.missile_list[missile_index].y = self.action_space[i].missile_y[1]
        # for i in range(len(agent_result)):
        #     print(agent_result[i])
        # print("我的位置变了吗")
        # for i in range(self.n_agent):
        #     print(str(i)+": "+str(self.missile_list[i].x)+" "+str(self.missile_list[i].y))
        return
