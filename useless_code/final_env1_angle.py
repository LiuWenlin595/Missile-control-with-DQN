...
class Select():
    ...
    def __init__(self):
        # 更新
        target1_1 = Boat(x=400, y=100, r=0, passby=0, defend=0, v=300, die_v=300, name='T1_1', m_x=[300, 250], m_y=[100, 100])    # 航母
        target2_1 = Boat(x=350, y=40, r=40, passby=0.4, defend=0.6, v=50, die_v=50, name='T2_1', m_x=[300, 250], m_y=[69, 98])    # 敢死队前上
        target2_2 = Boat(x=350, y=160, r=40, passby=0.4, defend=0.6, v=50, die_v=50, name='T2_2', m_x=[300, 250], m_y=[131, 102])    # 敢死队前下
        target2_3 = Boat(x=375, y=30, r=40, passby=0.4, defend=0.6, v=50, die_v=50, name='T2_3', m_x=[300, 250], m_y=[73, 102])    # 敢死队后上
        target2_4 = Boat(x=375, y=170, r=40, passby=0.4, defend=0.6, v=50, die_v=50, name='T2_4', m_x=[300, 250], m_y=[137, 98])     # 敢死队后下
        target2_5 = Boat(x=390, y=100, r=30, passby=0.3, defend=0.5, v=50, die_v=50, name='T2_5', m_x=[300, 250], m_y=[100, 100])    # 航母前
        target2_6 = Boat(x=400, y=80, r=30, passby=0.3, defend=0.5, v=50, die_v=50, name='T2_6', m_x=[300, 250], m_y=[138, 167])    # 航母上
        target2_7 = Boat(x=410, y=100, r=30, passby=0.3, defend=0.5, v=50, die_v=50, name='T2_7', m_x=[300, 250], m_y=[100, 100])    # 航母后
        target2_8 = Boat(x=400, y=120, r=30, passby=0.3, defend=0.5, v=50, die_v=50, name='T2_8', m_x=[300, 250], m_y=[62, 33])    # 航母下

        # todo  这里需要根据地图的具体大小进行更改
        missile1 = Missile(x=300, y=28, type=0, name='Z1')   # 导弹1
        missile2 = Missile(x=300, y=44, type=0, name='Z2')   # 导弹2
        missile3 = Missile(x=300, y=60, type=0, name='Z3')   # 导弹3
        missile4 = Missile(x=300, y=76, type=0, name='Z4')   # 导弹4
        missile5 = Missile(x=300, y=92, type=0, name='Z5')   # 导弹5
        missile6 = Missile(x=300, y=108, type=0, name='Z6')   # 导弹6
        missile7 = Missile(x=300, y=124, type=0, name='Z7')   # 导弹7
        missile8 = Missile(x=300, y=140, type=0, name='Z8')   # 导弹8
        missile9 = Missile(x=300, y=156, type=0, name='Z9')   # 导弹9
        missile10 = Missile(x=300, y=172, type=0, name='Z10')   # 导弹10
        missile11 = Missile(x=250, y=28, type=0, name='Z11')   # 导弹11
        missile12 = Missile(x=250, y=44, type=0, name='Z12')   # 导弹12
        missile13 = Missile(x=250, y=60, type=0, name='Z13')   # 导弹13
        missile14 = Missile(x=250, y=76, type=0, name='Z14')   # 导弹14
        missile15 = Missile(x=250, y=92, type=0, name='Z15')   # 导弹15
        missile16 = Missile(x=250, y=108, type=0, name='Z16')   # 导弹16
        missile17 = Missile(x=250, y=124, type=0, name='Z17')   # 导弹17
        missile18 = Missile(x=250, y=140, type=0, name='Z18')   # 导弹18
        missile19 = Missile(x=250, y=156, type=0, name='Z19')   # 导弹19
        missile20 = Missile(x=250, y=172, type=0, name='Z20')   # 导弹20
    ...
    def reset_all(self):
        for i in range(10):
            self.missile_list[i].x = 300
            self.missile_list[i].y = 28 + 16*i
            self.missile_list[i+10].x = 250
