...
class Select():
    ...
    def __init__(self):
        ...
        target2_1 = Boat(x=350, y=40, r=40, passby=0.4, defend=0.6, v=150, die_v=150, name='T2_1', m_x=[300, 250], m_y=[69, 98])    # 敢死队前上
        target2_2 = Boat(x=350, y=160, r=40, passby=0.4, defend=0.6, v=150, die_v=150, name='T2_2', m_x=[300, 250], m_y=[131, 102])    # 敢死队前下
        target2_3 = Boat(x=375, y=30, r=40, passby=0.4, defend=0.6, v=150, die_v=150, name='T2_3', m_x=[300, 250], m_y=[73, 102])    # 敢死队后上
        target2_4 = Boat(x=375, y=170, r=40, passby=0.4, defend=0.6, v=150, die_v=150, name='T2_4', m_x=[300, 250], m_y=[127, 98])     # 敢死队后下
        target2_5 = Boat(x=390, y=100, r=30, passby=0.3, defend=0.5, v=120, die_v=120, name='T2_5', m_x=[300, 250], m_y=[100, 100])    # 航母前
        target2_6 = Boat(x=400, y=80, r=30, passby=0.3, defend=0.5, v=120, die_v=120, name='T2_6', m_x=[300, 250], m_y=[138, 167])    # 航母上
        target2_7 = Boat(x=410, y=100, r=30, passby=0.3, defend=0.5, v=80, die_v=80, name='T2_7', m_x=[300, 250], m_y=[100, 100])    # 航母后
        target2_8 = Boat(x=400, y=120, r=30, passby=0.3, defend=0.5, v=120, die_v=120, name='T2_8', m_x=[300, 250], m_y=[62, 33])    # 航母下
