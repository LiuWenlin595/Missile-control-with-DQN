...
class Select():
    ...
    def __init__(self):
        # 更新
        target1_1 = Boat(x=400, y=45, r=0, passby=0, defend=0, v=300, die_v=300, name='T1_1')       # 航母上
        target1_2 = Boat(x=400, y=45, r=0, passby=0, defend=0, v=300, die_v=300, name='T1_2')       # 航母下
        target2_1 = Boat(x=300, y=20, r=15, passby=0.4, defend=0.6, v=50, die_v=50, name='T2_1')    # 敢死队前上
        target2_2 = Boat(x=300, y=80, r=15, passby=0.4, defend=0.6, v=50, die_v=50, name='T2_2')    # 敢死队前下
        target2_3 = Boat(x=350, y=15, r=15, passby=0.4, defend=0.6, v=50, die_v=50, name='T2_3')    # 敢死队后上
        target2_4 = Boat(x=325, y=20, r=15, passby=0.4, defend=0.6, v=50, die_v=50, name='T2_4')    # 敢死队中上
        target2_5 = Boat(x=325, y=80, r=15, passby=0.4, defend=0.6, v=50, die_v=50, name='T2_5')    # 敢死队中下
        target2_6 = Boat(x=350, y=85, r=15, passby=0.4, defend=0.6, v=50, die_v=50, name='T2_6')    # 敢死队后下
        target2_7 = Boat(x=380, y=50, r=12, passby=0.3, defend=0.5, v=50, die_v=50, name='T2_7')    # 航母前
        target2_8 = Boat(x=390, y=40, r=12, passby=0.3, defend=0.5, v=50, die_v=50, name='T2_8')    # 航母前上
        target2_9 = Boat(x=410, y=40, r=12, passby=0.3, defend=0.5, v=50, die_v=50, name='T2_9')    # 航母后上
        target2_10 = Boat(x=420, y=50, r=12, passby=0.3, defend=0.5, v=50, die_v=50, name='T2_10')  # 航母后
        target2_11 = Boat(x=410, y=60, r=12, passby=0.3, defend=0.5, v=50, die_v=50, name='T2_11')  # 航母后下
        target2_12 = Boat(x=390, y=60, r=12, passby=0.3, defend=0.5, v=50, die_v=50, name='T2_12')  # 航母前下

        # todo  这里需要根据地图的具体大小进行更改
        missile1 = Missile(x=120, y=14, type=0, name='Z1')   # 导弹1
        missile2 = Missile(x=120, y=22, type=0, name='Z2')   # 导弹2
        missile3 = Missile(x=120, y=30, type=0, name='Z3')   # 导弹3
        missile4 = Missile(x=120, y=38, type=0, name='Z4')   # 导弹4
        missile5 = Missile(x=120, y=46, type=0, name='Z5')   # 导弹5
        missile6 = Missile(x=120, y=54, type=0, name='Z6')   # 导弹6
        missile7 = Missile(x=120, y=62, type=0, name='Z7')   # 导弹7
        missile8 = Missile(x=120, y=70, type=0, name='Z8')   # 导弹8
        missile9 = Missile(x=120, y=78, type=0, name='Z9')   # 导弹9
        missile10 = Missile(x=120, y=86, type=0, name='Z10')   # 导弹10
        missile11 = Missile(x=80, y=14, type=0, name='Z11')   # 导弹11
        missile12 = Missile(x=80, y=22, type=0, name='Z12')   # 导弹12
        missile13 = Missile(x=80, y=30, type=0, name='Z13')   # 导弹13
        missile14 = Missile(x=80, y=38, type=0, name='Z14')   # 导弹14
        missile15 = Missile(x=80, y=46, type=0, name='Z15')   # 导弹15
        missile16 = Missile(x=80, y=54, type=0, name='Z16')   # 导弹16
        missile17 = Missile(x=80, y=62, type=0, name='Z17')   # 导弹17
        missile18 = Missile(x=80, y=70, type=0, name='Z18')   # 导弹18
        missile19 = Missile(x=80, y=78, type=0, name='Z19')   # 导弹19
        missile20 = Missile(x=80, y=86, type=0, name='Z20')   # 导弹20
